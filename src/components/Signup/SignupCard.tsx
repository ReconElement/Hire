           ...
           <div className="px-3 py-3 mt-4 max-w-1/3 min-w-xs ">
            <div className="poppins-regular text-lightviolet bg-gradient-to-r  rounded-md from-lightviolet to-darkviolet ">
                ...
                <div className="flex flex-row justify-centre p-2">
                    <input type="text" name="firstname" id="firstname" onChange={setFirstName} placeholder="First Name" className="p-2 m-2 bg-darkviolet text-lightviolet rounded-xl outline-none shadow-sm shadow-lightblue min-w-2/5"/>
                    <input type="text" name="lastname" id="lastname" onChange={setLastName} placeholder="Last Name" className="p-2 m-2 bg-darkviolet text-lightviolet rounded-xl outline-none shadow-sm shadow-lightblue min-w-2/5"/>
                </div>
                <div className="flex flex-row justify-centre p-2 ">
                    <input type="email" name="email" id="email" onChange={setEmail} placeholder="Email" className="p-2 m-2 bg-darkviolet text-lightviolet rounded-xl container outline-none shadow-lightblue shadow-sm" />
                </div>
                <div className="flex flex-row justify-centre p-2 ">
                ...
                <div className="flex flex-row justify-centre p-2 ">
                    <input type="password" name="password" id="password" onChange={setPassword} placeholder="Password" className='p-2 m-2 bg-darkviolet text-lightviolet container rounded-xl outline-none shadow-lightblue shadow-sm'/>
                </div>
